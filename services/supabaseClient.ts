...
export interface Database {
  public: {
    Tables: {
      ...
      users: {
        Row: { // The data coming from the database
          ...
          status: 'pending_payment' | 'inactive' | 'lifetime' | 'admin' | 'subscription' | 'trial' | 'apple_user'
          api_key: string | null
    ...
    Enums: {
      ...
      user_status: 'pending_payment' | 'inactive' | 'lifetime' | 'admin' | 'subscription' | 'trial' | 'apple_user'
